            ...
            <div className="pt-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="mailto:ivanfinan@gmail.com" className="text-gray-300 hover:text-white">ivanfinan@gmail.com</a>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="text-blue-500">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="https://dreamhigh.netlify.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">dreamhigh.netlify.com</a>
                </div>
              </div>
            </div>
          </div>
